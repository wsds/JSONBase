...
DMLIST * newDMLIST() {
	MemorySpace * space = map_malloc(sizeof(DMLIST));
...
bool DMLIST::resize() {
	...
	MemorySpace * new_elements_space = map_malloc(mem_size);
...
bool DMLIST::initialize() {
	...
	this->elements_space = map_malloc(mem_size);
